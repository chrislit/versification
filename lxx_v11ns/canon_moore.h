/******************************************************************************
 *
 *  canon_moore.h -	Versification data for the Moore system
 *
 * $Id: canon_moore.h 461 2013-07-30 10:02:43Z chrislit $
 *
 * Copyright 2014
 *
...
#ifndef CANON_MOORE_H
#define CANON_MOORE_H

SWORD_NAMESPACE_START


// Versification system: Moore
// Book order: Ps

// Source: http://www.synaxis.info/psalter/5_english/c_psalms/FrLazarusMoore-Psalter.txt

/******************************************************************************
 * [on]tbooks_moore - initialize static instance for all canonical
 *		 text names and chapmax
 */
struct sbook otbooks_moore[] = {
  {"Genesis", "Gen", "Gen", 50},
  {"Exodus", "Exod", "Exod", 40},
...
int vm_moore[] = {
  ...
  0, 0, 0, 0, 0, 0, 0, 0,
  // Psalms
  6, 13, 8, 9, 13, 9, 18, 10, 39, 7, 
  8, 6, 7, 5, 11, 15, 50, 14, 9, 13, 
  31, 6, 10, 22, 12, 14, 9, 11, 12, 24, 
  11, 22, 22, 28, 12, 40, 22, 14, 18, 13, 
  11, 6, 27, 18, 12, 10, 15, 20, 23, 19, 
  10, 7, 7, 24, 14, 12, 11, 19, 12, 9, 
  13, 12, 11, 14, 20, 7, 36, 37, 7, 6, 
  19, 28, 23, 10, 12, 20, 72, 13, 19, 16, 
  8, 18, 12, 13, 17, 7, 18, 53, 17, 16, 
  15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 
  29, 22, 35, 45, 48, 43, 14, 31, 7, 10, 
  10, 9, 26, 9, 10, 2, 29, 176, 7, 8, 
  9, 4, 8, 5, 7, 5, 6, 8, 8, 3, 
  18, 3, 3, 21, 26, 8, 8, 24, 15, 10, 
  8, 12, 15, 22, 10, 11, 9, 14, 9, 6,
  7,
  // Prayer of Manasses
  0,
  // Proverbs
