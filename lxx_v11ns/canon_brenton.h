/******************************************************************************
 *
 *  canon_brenton.h - Versification data for the Brenton system
 *
 * $Id: canon_brenton.h 448 2013-07-25 12:40:06Z chrislit $
 *
 * Copyright 2014
 *
...
#ifndef CANON_BRENTON_H
#define CANON_BRENTON_H

SWORD_NAMESPACE_START


// Versification system: Brenton
// Book order: Gen Exod Lev Num Deut Josh Judg Ruth 1Sam 2Sam 1Kgs 2Kgs 1Chr 2Chr Ezra Neh Esth Job Ps Prov Eccl Song Isa Jer Lam Ezek Dan Hos Joel Amos Obad Jonah Mic Nah Hab Zeph Hag Zech Mal Tob Jdt Wis Sir Bar EpJer PrAzar Sus Bel 1Macc 2Macc 1Esd PrMan 3Macc 4Macc

// Source: http://books.google.com/books?id=9GRYAAAAMAAJ
//         http://books.google.com/books?id=0XsRAAAAYAAJ
//         http://books.google.com/books?id=C79hTt29XVsC

/******************************************************************************
 * [on]tbooks_brenton - initialize static instance for all canonical
 *		 text names and chapmax
 */
struct sbook otbooks_brenton[] = {
  {"Genesis", "Gen", "Gen", 50},
  {"Exodus", "Exod", "Exod", 40},
...
int vm_brenton[] = {
  ...
  // IV Maccabees
  35, 24, 21, 26, 38, 35, 25, 27, 32, 21,
  27, 20, 26, 20, 32, 25, 24, 24
  // Psalms
  ...
  28, 27, 27, 34, 26, 29, 30, 26, 28, 24,
  26, 20, 31, 31, 24, 26, 31, 34, 35, 30,
